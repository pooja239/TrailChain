...
class Update extends OperationBase {
     ...
     */
    createSimpleState() {
        return new SimpleState(this.workerIndex, this.Marketplace, this.ratio, 1);
    }
    ...
    async submitTransaction() {
        const updateArgs = this.simpleState.getUpdatemultipleT3Arguments();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('updateT3', updateArgs));
    }
}
